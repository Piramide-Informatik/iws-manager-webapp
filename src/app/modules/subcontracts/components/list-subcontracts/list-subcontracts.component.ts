...
export class ListSubcontractsComponent implements OnInit, OnDestroy {
  ...
  dataKeys = ['orderTitle', 'contractor', 'project', 'date', 'invoiceNumber', 'net', 'gross', 'share'];
  ...
  loadColHeaders(): void {
    this.cols = [
          ...
          { field: 'invoiceNumber', customClasses: ['align-right'], header: this.translate.instant(_('SUB-CONTRACTS.TABLE.INVOICE_NUMBER'))},
          { field: 'net', customClasses: ['align-right'], header: this.translate.instant(_('SUB-CONTRACTS.TABLE.NET_INVOICE'))},
